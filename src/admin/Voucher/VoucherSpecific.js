    ...
    return (
        <div className="voucher">
            <div className="">
                <div className="mb-3">
                    <div>
                        <div style={{ fontSize: "18px", backgroundColor: "#ff7f7f" }} className="badge">Voucher cho sản phẩm cụ thể</div>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className='top'>
                        ...
                        <div className="mb-3">
                            <label className="form-label me-3">Giảm giá được áp dụng</label>
                        ...
                        <button type="submit" className="btn btn-primary">Tạo mã giảm giá</button>
                    </div>
                </form>
            </div>
        </div>
